...
public class EntityEnderSignal extends Entity {
    ...
    public void y_() {
        ...
        for (this.pitch = (float) (TrigMath.atan2(this.motY, (double) f) * 180.0D / 3.1415927410125732D); this.pitch - this.lastPitch < -180.0F; this.lastPitch -= 360.0F) { // CraftBukkit - Use TrigMath.atan2 instead of Math.atan2
            ;
        }
        ...
        if (!this.world.isStatic) {
            ...
            float f2 = (float) TrigMath.atan2(d1, d0); // CraftBukkit - Use TrigMath.atan2 instead of Math.atan2
